...
function setupEventListeners() {
  ...
  // Results Details Accordion - Score Calc
  const calcHeader = document.getElementById('score-calc-toggle-header');
  const calcContent = document.getElementById('score-calc-content');
  calcHeader.addEventListener('click', () => {
    calcHeader.classList.toggle('active');
    calcContent.classList.toggle('collapsed');
  });

  // Results Details Accordion - Response Log
  const logHeader = document.getElementById('response-log-toggle-header');
  const logContent = document.getElementById('response-log-content');
  logHeader.addEventListener('click', () => {
    logHeader.classList.toggle('active');
  ...
  triadData.forEach(triad => {
    ...
    item.innerHTML = `
      ...
      <div class="triad-bar-bg">
        <div class="triad-bar-fill" style="--triad-fill-width: ${pct}%; --triad-color: ${triad.color};"></div>
      </div>
...
function restartAssessment() {
  if (confirm('Are you sure you want to discard your results and retake the Enneagram assessment?')) {
    ...
    const calcHeader = document.getElementById('score-calc-toggle-header');
    const calcContent = document.getElementById('score-calc-content');
    calcHeader.classList.remove('active');
    calcContent.classList.add('collapsed');

    const logHeader = document.getElementById('response-log-toggle-header');
    const logContent = document.getElementById('response-log-content');
    logHeader.classList.remove('active');
